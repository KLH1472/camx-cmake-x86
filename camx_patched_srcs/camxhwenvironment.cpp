    ...
    ) const
{
    ...
    {
        static const SensorModuleStaticCaps  s_defaultSensorCaps = {};
        static const PlatformStaticCaps       s_defaultPlatCaps  = {};
        static const HwEnvironmentStaticCaps  s_defaultEnvCaps   = {};
        pCameraInfo->imageSensorFacing        = ImageSensorFacingExternal;
        pCameraInfo->imageOrientation         = ImageOrientationCW0;
        pCameraInfo->mountAngle               = 0;
        pCameraInfo->pSensorCaps              = &s_defaultSensorCaps;
        pCameraInfo->pPlatformCaps            = &s_defaultPlatCaps;
