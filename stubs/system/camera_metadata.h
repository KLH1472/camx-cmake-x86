...
// Tag type macros — section << 16 matches Android camera_metadata_tags.h
#define CAMERA_METADATA_ENUM_VAL(section) ((section) << 16)
#define CAMERA_METADATA_ENUM_VAL_START 0x80000000

// Offsets below match CamX CameraMetadataTag enum in camxhal3metadatatags.h

// Android sensor info tags (section 15)
...
// Android request (section 12)
#define ANDROID_REQUEST_AVAILABLE_CAPABILITIES \
    (CAMERA_METADATA_ENUM_VAL(ANDROID_REQUEST) | 0x0C)

#define ANDROID_REQUEST_MAX_NUM_OUTPUT_STREAMS \
    (CAMERA_METADATA_ENUM_VAL(ANDROID_REQUEST) | 0x06)
