...
#ifndef CAMX_TEST_INPUT_PATH
const std::string inputImagePath = "/data/vendor/camera/";
#else
const std::string inputImagePath = CAMX_TEST_INPUT_PATH;
#endif

#ifndef CAMX_TEST_OUTPUT_PATH
const std::string outputImagePath = "/data/vendor/camera/chifeature2test/";
#else
const std::string outputImagePath = CAMX_TEST_OUTPUT_PATH;
#endif
