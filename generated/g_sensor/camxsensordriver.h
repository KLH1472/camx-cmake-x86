...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// DelayInfoType
/// Comments:      Indicates for which category the delay Info belongs to
///                Supported types are ExposureControl, Framesync. Framesync delay info is used for multi camera
///                synchronization
///                For all exposure control purposes ExposureControl type is used including the maxpipeline delay
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
enum class DelayInfoType
{
    EXPOSURECONTROL = 0,
    FRAMESYNC       = 1
};
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// MipiFlagsType
/// Comments:      Mipi flags that receiver needs to take care
///                Supported flags are: EPDEnabled, DSKEWCalibEnabled
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
enum class MipiFlagsType
{
    EPDEnabled        = 0,
    DSKEWCalibEnabled = 1
};
...
/// Min Length:    1
/// Max Length:    Unbounded
/// Comments:      List of Mipi flags that Mipi recever needs to take care of
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef MipiFlagsType* MipiFlagsList;
...
struct ResolutionData
{
    ...
    /// Max Length:    Unbounded
    /// Comments:      List of Mipi flags that Mipi recever needs to take care of
    ///                Any extra mipi parameters that recevier should take care of
    ///                EPDEnabled, DSKEWCalibEnabled
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    UINT32                         mipiFlagsCount;
    UINT32                         mipiFlagsID;
    MipiFlagsList                  mipiFlags;
};
