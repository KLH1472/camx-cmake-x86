...
#define XLOGE(fmt, ...) __android_log_print(ANDROID_LOG_ERROR,   LOG_TAG, "[ERROR][CORE   ] %s:%d %s() " fmt, XLOG_FILENAME, __LINE__, __func__, ##__VA_ARGS__)
#define XLOGW(fmt, ...) __android_log_print(ANDROID_LOG_WARN,    LOG_TAG, "[ WARN][CORE   ] %s:%d %s() " fmt, XLOG_FILENAME, __LINE__, __func__, ##__VA_ARGS__)
#define XLOGI(fmt, ...) __android_log_print(ANDROID_LOG_INFO,    LOG_TAG, "[ INFO][CORE   ] %s:%d %s() " fmt, XLOG_FILENAME, __LINE__, __func__, ##__VA_ARGS__)
#define XLOGD(fmt, ...) __android_log_print(ANDROID_LOG_DEBUG,   LOG_TAG, "[DEBUG][CORE   ] %s:%d %s() " fmt, XLOG_FILENAME, __LINE__, __func__, ##__VA_ARGS__)
#define XLOGV(fmt, ...) __android_log_print(ANDROID_LOG_VERBOSE, LOG_TAG, "[ VERB][CORE   ] %s:%d %s() " fmt, XLOG_FILENAME, __LINE__, __func__, ##__VA_ARGS__)
