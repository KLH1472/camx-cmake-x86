...
struct StaticSettings
{
    ...
    UINT32  debugBufferRegDumpFileNamePrefix;
    ...
    UINT32  customAlgoAECName;
    UINT32  customAlgoAECPath;
    BOOL    enableCustomAlgoAWB;
    UINT32  customAlgoAWBName;
    UINT32  customAlgoAWBPath;
    BOOL    enableCustomAlgoAF;
    UINT32  customAlgoAFName;
    UINT32  customAlgoAFPath;
    BOOL    enableCustomHAFAlgo;
    UINT32  customHAFAlgoName;
    UINT32  customHAFAlgoPath;
    ...
    UINT32  customAlgoASDName;
    UINT32  customAlgoASDPath;
    BOOL    enableCustomAlgoAFD;
    UINT32  customAlgoAFDName;
    UINT32  customAlgoAFDPath;
    BOOL    enableDualIFE;
    BOOL    forceDualIFEOn;
    ...
    UINT32  customPDLibName;
    UINT32  customPDLibPath;
    BOOL    tintlessEnable;
    ...
    UINT32  accelVendorTagSection;
    UINT32  accelVendorTagName;
    ...
    UINT32  inducerPipelineName;
    UINT32  inducerNodeName;
